...
namespace Anima2D
{
    public class SpriteMesh : ScriptableObject
    {
        ...
        public Sprite sprite { get { return m_Sprite; } set { this.m_Sprite = value != null ? value : this.m_Sprite; } }
        public Mesh sharedMesh { get { return m_SharedMesh; } set { this.m_SharedMesh = value != null ? value : this.m_SharedMesh; } }
