...
namespace Anima2D
{
	...
	public class SpriteMeshInstance : MonoBehaviour
	{
        ...
        SpriteMesh m_SpriteMeshOriginal;
        ...
        public SpriteMesh spriteMesh {
			...
			set {
                ...
                {
                    Debug.Log("Instance");
                    m_SpriteMeshOriginal = value;
                    m_SpriteMesh = ScriptableObject.CreateInstance<SpriteMesh>();
		...
		{
			if(!Application.isPlaying && spriteMesh && spriteMesh == m_SpriteMeshOriginal)
			{
		...
		void LateUpdate()
		{
            if (spriteMesh && spriteMesh.sharedMesh && m_SpriteMeshOriginal == null)
            {
                spriteMesh = m_SpriteMesh;
            }
